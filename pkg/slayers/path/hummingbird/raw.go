...
// Attaches previous flyoverfield to current hopfield.
// DOES NOT adapt MACS.
...
func (s *Raw) DoFlyoverXover() error {
	...
	hopOffset := MetaLen + s.NumINF*path.InfoLen + idx*LineLen - FlyoverLen
	if s.Raw[hopOffset+FlyoverLen]&0x80 == 0x80 {
